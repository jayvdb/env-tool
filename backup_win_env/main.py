...
def parseArgs():
    ...
    parser.add_argument("-i", "--import", dest="input", required=False, metavar="xxx.yml", help="从文件导入环境变量")
    parser.add_argument("-o", "--export", dest="output", required=False, metavar="yyy.yml", help="将变量导出至文件")
    parser.add_argument("-v", "--view",   dest="view",   required=False, default=False, action="store_true", help="预览效果, 但不执行")
